...
/*
   This file is supposed to replicate the noop example,
   with the gRPC function implementations
 */
...
int main(int argc, char *argv[])
{
    ...
    /* arax_init and arax_exit are called in the AraxServer constructor and destructor respectively */
...
//     }
//     
//     client.client_arax_accel_acquire_type(CPU, "one");
//     client.client_arax_proc_register("noop");
//     size_t size       = strlen(argv[1]) + 1;
//     char *out         = (char *) calloc(size, 1);
//     char *temp        = (char *) calloc(size, 1);

//     client.client_arax_buffer(size, "input");
//     client.client_arax_buffer(size, "output");

//     // arax_data_set(io[0], accel, argv[1]);

//     client.client_arax_task_issue("one", "noop", 1, "input", 1, "output");
...
//     // arax_data_free(io[1]);
//     // arax_task_free(task);
//     client.client_arax_proc_put("noop");
//      
//     client.client_arax_accel_release("one");
